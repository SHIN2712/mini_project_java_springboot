...
public class MemberShipTest {
	...
	public static void main(String[] args) {
		...
		// 100000 만원 짜리 물건을 살때 가격을 출력
		System.out.println("100000 만원 짜리 물건을 살때 FAMILY Member \'" + salesReport.FamilyMembers + "\'와 VIP Member \'" + salesReport.VIPMembers + "\'이 지불해야하는 가격을 출력하기");
		System.out.println();
		salesReport.generateSaleReport(100000);
		System.out.println();
		
		// 250000 만원 짜리 물건을 살때 가격을 출력
	    System.out.println("250000 만원 짜리 물건을 살때 FAMILY Member \'" + salesReport.FamilyMembers + "\'와 VIP Member \'" + salesReport.VIPMembers + "\'이 지불해야하는 가격을 출력하기");
	    System.out.println();
